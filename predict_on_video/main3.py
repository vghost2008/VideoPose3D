...
if __name__ == "__main__":
    ...
    exp_name = wmlu.base_name(frames_path[0])+"_vp3d"
    kpd = KPDetection()

    save_dir = "/home/wj/ai/mldata/pose3d/tmp/predict_on_video_"+exp_name
    ...
    cache_path = osp.join(cache_dir,exp_name)
    ...
    if use_scores:
        ...
        suffix = "_v1"
    save_dir = "/home/wj/ai/mldata/pose3d/tmp/predict_on_video_"+exp_name+suffix
    cache_dir = "/home/wj/ai/mldata/pose3d/tmp/cache"
    ...
    save_path = osp.join(save_dir,f"{exp_name}.mp4")

    pos_3d = video_pos_3d(kps0,scale_data=True,flip=False)
